...
So far we have considered models of an algebraic theory in the category of sets. We can
consider more generally models in any category with finite products. Indeed, we may
transcribe the definitions of interpretation and model from
Sections~\ref{sec:interp-of-sign} and~\ref{sec:models-algebr-theor} so that it applies
to~$\CC$. An interpretation $I$ in $\CC$ is given by
%
\begin{enumerate}
