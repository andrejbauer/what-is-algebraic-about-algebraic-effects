...
At the Dagstuhl seminar ``Algebraic effect handlers go
mainstream''~\cite{chandrasekaran18:_algeb} I gave a short tutorial on algebraic
theories and how they relate to algebraic effects and handlers. This note
recapitulates and somewhat expands the contents of the tutorial. I assume some
amount of undergraduate mathematics and familiarity with algebraic effects and
handlers. Matija Pretnar's tutorial on algebraic effects and
handlers~\cite{Pretnar15} is a prerequisite, as we will use the programming
language presented therein. As is becoming of a tutorial, numerous examples are
provided.
